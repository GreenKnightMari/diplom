...
plt.rcParams.update({
    ...
    'xtick.color':      '#111827',
    'ytick.color':      '#111827',
    'axes.labelsize':   13,      # Аккуратный размер подписей осей
    'xtick.labelsize':  11,      # Числа на оси X
    'ytick.labelsize':  11,      # Числа на оси Y
    'legend.fontsize':  11,      # Шрифт легенды
    'axes.titlesize':   15,      # Заголовок
...
# ---------------------------------------------------------------------
# ВКЛАДКА 1 — СВОДНЫЙ РАСЧЁТ И КРИВЫЕ РАСПРЕДЕЛЕНИЯ
# ---------------------------------------------------------------------
with tab1:
...
# ---------------------------------------------------------------------
# ВКЛАДКА 3 — 3D ПОВЕРХНОСТЬ РЕШЕНИЙ
# ---------------------------------------------------------------------
with tab3:
